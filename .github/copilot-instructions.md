...
- Flask entry: run.py and wxcloudrun/__init__.py; HTTP routes in wxcloudrun/views.py, WeCom routes in wxcloudrun/wxwork.py (Blueprint /wxwork).
- MongoDB access is centralized in wxcloudrun/dao.py (PyMongo). DAO returns plain dicts; DB name is hard-coded as "wecom-development".
