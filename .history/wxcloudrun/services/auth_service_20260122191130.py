...
def get_permanent_code(auth_code: str) -> Optional[Tuple[str, dict]]:
    ...
    try:
        ...
        if result.get("errcode", 0) != 0:
            ...
            logging.getLogger("wxcloudrun.auth_service").error(
        ...
        logging.getLogger("wxcloudrun.auth_service").exception(
            "Exception in get_permanent_code for auth_code=%s: %s", auth_code, e
        )
        return None
