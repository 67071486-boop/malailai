...
def callback():
    """企业微信回调处理"""
    logger.error(f"环境变量 - TOKEN: {WXWORK_TOKEN}, AES_KEY: {WXWORK_ENCODING_AES_KEY}, SUITE_ID: {WXWORK_SUITE_ID}")
    try:
        try:
            wxcpt = WXBizMsgCrypt("m9fLBXIC31e8RJisyj3qM7Qw", "ma0V4JrLov2HzxDMASiu6mKt8nW0PbP1IvzTPfielH2", "wwd7e303c670a17200")
        except Exception as e:
