...
const _sfc_main = {
  ...
  mounted() {
    ...
    common_vendor.index.createIntersectionObserver(this.$scope, { nativeMode: true }).relativeToViewport({ bottom: 0 }).observe(".uni-im-load-state", onIntersect);
  },
  onShow() {
    if (uni_modules_uniIm_sdk_index.uniIm.group.hasMore && uni_modules_uniIm_sdk_index.uniIm.group.dataList.length === 0) {
      uni_modules_uniIm_sdk_index.uniIm.group.loadMore();
    }
  },
  onLoad(options) {
...
const _easycom_uni_im_info_card = () => "../../../uni_modules/uni-im/components/uni-im-info-card/uni-im-info-card.js";
const _easycom_uni_im_load_state = () => "../../../uni_modules/uni-im/components/uni-im-load-state/uni-im-load-state.js";
if (!Math) {
  (_easycom_uni_search_bar + _easycom_uni_im_info_card + _easycom_uni_im_load_state)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o($options.doClear, "7c"),
    b: common_vendor.o($options.doClear, "4c"),
    c: common_vendor.o(($event) => $data.keyword = $event, "33"),
    d: common_vendor.p({
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/workbench/groupList/groupList.js.map
