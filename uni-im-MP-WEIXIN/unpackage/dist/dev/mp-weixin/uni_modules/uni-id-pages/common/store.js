  ...
  updateUserInfo(data2 = false) {
    return __async(this, null, function* () {
      if (data2) {
        ...
        try {
          let res = yield usersTable.where("'_id' == $cloudEnv_uid").field("mobile,nickname,username,email,avatar_file").get();
          const realNameRes = yield uniIdCo2.getRealNameInfo();
          this.setUserInfo(__spreadProps(__spreadValues({}, res.result.data[0]), {
