...
const _sfc_main = {
  ...
  methods: {
    ...
    login_before(_0) {
      return __async(this, arguments, function* (type, navigateBack = true, options = {}) {
        var _a, _b;
        ...
        if (type == "univerify") {
          ...
          let onButtonsClickFn = (res) => __async(this, null, function* () {
            ...
            let checkBoxState = yield common_vendor.index.getCheckBoxState();
        ...
        common_vendor.index.login({
          ...
          success: (e) => __async(this, null, function* () {
            if (type == "apple") {
              let res = yield this.getUserInfo({
                provider: "apple"
              });
