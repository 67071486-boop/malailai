...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o((...args) => $options.quickLogin && $options.quickLogin(...args), "fc"),
    e: $options.imgSrc
  } : {
    f: common_vendor.o((...args) => $options.quickLogin && $options.quickLogin(...args), "b5")
  }, {
    ...
    i: common_vendor.o((...args) => $options.chooseArea && $options.chooseArea(...args), "86"),
    j: common_vendor.o(($event) => $data.focusPhone = false, "e7"),
    k: common_vendor.o(($event) => $data.phone = $event, "13"),
    l: common_vendor.p({
      trim: "both",
    ...
    o: common_vendor.o((...args) => $options.toSmsPage && $options.toSmsPage(...args), "c5")
  }, {
