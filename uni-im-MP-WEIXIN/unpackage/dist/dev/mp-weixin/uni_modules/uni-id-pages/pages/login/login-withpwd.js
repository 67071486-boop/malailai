...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.o(($event) => $data.focusPassword = false, "7f"),
    g: common_vendor.o(($event) => $data.password = $event, "82"),
    h: common_vendor.p({
    ...
    l: common_vendor.o(($event) => $data.captcha = $event, "e4"),
    m: common_vendor.p({
      focus: true,
      scene: "login-by-pwd",
    ...
    p: common_vendor.o((...args) => $options.pwdLogin && $options.pwdLogin(...args), "cb"),
    q: !_ctx.config.isAdmin
  }, !_ctx.config.isAdmin ? {
    r: common_vendor.o((...args) => $options.toRetrievePwd && $options.toRetrievePwd(...args), "84")
  } : {}, {
    s: common_vendor.t(_ctx.config.isAdmin ? "注册管理员账号" : "注册账号"),
    t: common_vendor.o((...args) => $options.toRegister && $options.toRegister(...args), "a1"),
