...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.o(($event) => $data.focusNickname = false, "1c"),
    g: common_vendor.o(($event) => $data.formData.nickname = $event, "bc"),
    h: common_vendor.p({
      inputBorder: false,
    ...
    j: common_vendor.o(($event) => $data.focusPassword = false, "4f"),
    k: common_vendor.o(($event) => $data.formData.password = $event, "4c"),
    l: common_vendor.p({
      inputBorder: false,
    ...
    m: common_vendor.o(($event) => $data.formData.password = $event, "dd"),
    n: common_vendor.p({
      name: "password",
      required: true,
      modelValue: $data.formData.password
    }),
    o: common_vendor.o(($event) => $data.focusPassword2 = false, "95"),
    p: common_vendor.o(($event) => $data.formData.password2 = $event, "52"),
    q: common_vendor.p({
      inputBorder: false,
    ...
    r: common_vendor.o(($event) => $data.formData.password2 = $event, "ca"),
    s: common_vendor.p({
      name: "password2",
      required: true,
      modelValue: $data.formData.password2
    }),
    t: common_vendor.sr("captcha", "43768f76-10,43768f76-9"),
    v: common_vendor.o(($event) => $data.formData.captcha = $event, "e6"),
    w: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    x: common_vendor.sr("agreements", "43768f76-11,43768f76-0"),
    y: common_vendor.p({
      scope: "register"
    }),
    z: common_vendor.o((...args) => $options.submit && $options.submit(...args), "e1"),
    A: common_vendor.o((...args) => $options.navigateBack && $options.navigateBack(...args), "b7"),
    B: common_vendor.o((...args) => $options.registerByEmail && $options.registerByEmail(...args), "bf"),
    C: common_vendor.o((...args) => $options.toLogin && $options.toLogin(...args), "3e"),
    D: common_vendor.sr("form", "43768f76-0"),
    E: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
