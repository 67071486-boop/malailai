...
const uniImCo = common_vendor._r.importObject("uni-im-co", { customUI: true });
class ConversationItem {
  ...
  clearUnreadCount() {
    ...
    common_vendor._r.database().collection("uni-im-conversation").where({
  ...
  changeMute() {
    this.mute = !this.mute;
    const db2 = common_vendor._r.database();
